...
public class RegistrationIntentService extends IntentService {
    ...
    private void sendRegistrationToServer(String token) {
        ...
        System.out.println("EL TOKEN: " + token + " :D");
        ContextoDAO.getContextoDAO().getPersona().getTelefono().get(0).setIdGcm(token);

        PersonaDAO personaDAO = new PersonaDAO();
        personaDAO.registrarPersona(ContextoDAO.getContextoDAO().getPersona());
    }
